...
- Architecture-level decisions (Server-authoritative vs Distributed Authority) → also load [architecture](../../../unity-architecture-advisory/modules/architecture/SKILL.md)
