...
- Asmdef & assembly layout for YooAsset consumers → load [asmdef](../../../unity-scripting/modules/asmdef/SKILL.md)
- Async orchestration across multiple YooAsset operations → load [async](../../../unity-scripting/modules/async/SKILL.md)
- Architecture-level decisions (Addressables vs YooAsset, single-package vs multi-package) → load [architecture](../../../unity-architecture-advisory/modules/architecture/SKILL.md)
- Performance review of load/release hot paths → load [performance](../../../unity-architecture-advisory/modules/performance/SKILL.md)
