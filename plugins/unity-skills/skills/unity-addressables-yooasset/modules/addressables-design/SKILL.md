...
- Asmdef layout for Addressables consumers → load [asmdef](../../../unity-scripting/modules/asmdef/SKILL.md)
- Async orchestration across multiple Addressables operations → load [async](../../../unity-scripting/modules/async/SKILL.md)
- Architecture-level decisions (Addressables vs YooAsset, group strategy) → load [architecture](../../../unity-architecture-advisory/modules/architecture/SKILL.md)
