...
- `qframework_group_*` / `qframework_entry_*` — that's the [addressables](../../../unity-addressables-yooasset/modules/addressables/SKILL.md) module's Groups vocabulary, not QFramework's.
...
- Runtime hot-update / bundle loading unrelated to QFramework's own AssetBundle marking → this module only covers ResKit's own build/mark/clear; general Addressables authoring is [addressables](../../../unity-addressables-yooasset/modules/addressables/SKILL.md).
