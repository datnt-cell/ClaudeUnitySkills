...
- 与 UniTask/协程的桥接（ActionKit 序列 vs async）→ [unitask-design](../../../unity-tweening/modules/unitask-design/SKILL.md) / [async](../../../unity-scripting/modules/async/SKILL.md)
- 整体架构分层评审、状态管理选型 → [architecture](../../../unity-architecture-advisory/modules/architecture/SKILL.md) / [patterns](../../../unity-scripting/modules/patterns/SKILL.md)
- 事件/BindableProperty 高频触发场景的性能评审 → [performance](../../../unity-architecture-advisory/modules/performance/SKILL.md)
- ResKit 底层如走 Addressables 的资源生命周期 → [addressables-design](../../../unity-addressables-yooasset/modules/addressables-design/SKILL.md)
- Asmdef 布局（QFramework.cs 与 Toolkits 分别装配）→ [asmdef](../../../unity-scripting/modules/asmdef/SKILL.md)
