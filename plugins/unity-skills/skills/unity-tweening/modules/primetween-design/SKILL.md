...
description: Source-anchored design rules for PrimeTween 1.4.6
---
...
- Async control flow or cancellation policy → load [async](../../../unity-scripting/modules/async/SKILL.md) and [unitask-design](../unitask-design/SKILL.md).
- Inspector-authored `TweenSettings` fields → load [inspector](../../../unity-architecture-advisory/modules/inspector/SKILL.md).
- Tween-heavy performance analysis → load [performance](../../../unity-architecture-advisory/modules/performance/SKILL.md).
- Addressables-loaded targets or scene lifetime → load [addressables-design](../../../unity-addressables-yooasset/modules/addressables-design/SKILL.md).
