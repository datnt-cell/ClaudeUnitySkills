...
> **DESIGN-FIRST**: Before creating gameplay scripts, actively consider coupling, performance, and maintainability. In an existing project, load `../../../unity-architecture-advisory/modules/project-scout/SKILL.md` first. If the user is asking for architecture or refactoring advice, load `../../../unity-architecture-advisory/modules/architecture/SKILL.md` and then `../patterns/SKILL.md`, `../async/SKILL.md`, `../../../unity-architecture-advisory/modules/inspector/SKILL.md`, `../../../unity-architecture-advisory/modules/performance/SKILL.md`, `../script-roles/SKILL.md`, `../../../unity-architecture-advisory/modules/scene-contracts/SKILL.md`, `../testability/SKILL.md`, or `../scriptdesign/SKILL.md` as needed.
...
Full transport-level codes (COMPILING/RATE_LIMIT etc.) → ../../../unity-core/references/protocol-error-codes.md
