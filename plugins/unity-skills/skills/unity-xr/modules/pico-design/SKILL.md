...
- 架构与生命周期决策 → [architecture](../../../unity-architecture-advisory/modules/architecture/SKILL.md) / [patterns](../../../unity-scripting/modules/patterns/SKILL.md) / [async](../../../unity-scripting/modules/async/SKILL.md)
- 性能审查热路径 → [performance](../../../unity-architecture-advisory/modules/performance/SKILL.md)
