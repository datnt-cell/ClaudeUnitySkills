...
Automate when the task involves **bulk material creation, batch property edits, shader keyword toggles across many materials, or render-queue changes** — use the [material](../../../unity-rendering/modules/material/SKILL.md) REST module instead.
...
- [material](../../../unity-rendering/modules/material/SKILL.md)
