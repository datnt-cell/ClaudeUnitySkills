...
Automate when the task involves **adding components to many objects, batch-configuring serialized fields, reflecting over property names, or enabling/disabling many components at once** — use the [component](../../../unity-scene-authoring/modules/component/SKILL.md) REST module instead.
...
- [component](../../../unity-scene-authoring/modules/component/SKILL.md)
