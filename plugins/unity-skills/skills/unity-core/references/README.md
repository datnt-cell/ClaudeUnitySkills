...
| `protocol-unity-cli.md` | The user opted into Unity CLI cold start and you must launch a closed Editor. Per-command detail lives in `../../unity-editor-tools/modules/unity-cli/SKILL.md`. |
