...
Automate when the task involves **bulk material creation, batch property edits, shader keyword toggles across many materials, or render-queue changes** — use the material (unity-rendering plugin) REST module instead.
...
- material (unity-rendering plugin)
