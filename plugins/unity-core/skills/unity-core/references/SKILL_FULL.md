...
| `MISSING_PACKAGE` | `install_and_retry` | The skill's optional package (ProBuilder / DOTween / YooAsset / URP …) is not installed | Install it with `package_install` (the message names the package id), wait out the Domain Reload, then retry |
