...
- Creating and organizing GameObjects / hierarchy / basic transforms → [`manual/manual-gameobject/SKILL.md`](manual/manual-gameobject/SKILL.md)
- Adding and configuring components in the Inspector → [`manual/manual-component/SKILL.md`](manual/manual-component/SKILL.md)
- Creating and editing materials / changing colors → [`manual/manual-material/SKILL.md`](manual/manual-material/SKILL.md)
- Navigating scenes, saving, and simple scene operations → [`manual/manual-scene/SKILL.md`](manual/manual-scene/SKILL.md)
